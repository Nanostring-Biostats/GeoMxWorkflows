...
``` {r sampleFlowAlluvial, fig.width = 10, fig.height = 4, fig.wide = TRUE, message = FALSE, warning = FALSE}
library(dplyr)
...
``` {r replotAlluvial, fig.width = 10, fig.height = 4, fig.wide = TRUE, message = FALSE, warning = FALSE}
...
pc <- parcats(p,
        marginal_histograms = FALSE,
        data_input = sampleOverviewFiltered,
        labelfont = list(size = 12, color = "black"),
        hoveron="dimension",
        hoverinfo = "count")
pc
